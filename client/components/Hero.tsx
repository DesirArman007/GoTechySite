          ...
          >
            ...
            <div className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px] lg:w-[400px] lg:h-[400px]">
              ...
              <motion.a
                ...
                className="absolute -left-4 sm:-left-6 top-1/2 flex items-center gap-1.5 sm:gap-2.5 bg-white/90 backdrop-blur-md pl-1.5 pr-3 py-1.5 sm:pl-2 sm:pr-4 sm:py-2 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
              >
                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full overflow-hidden shadow-sm shrink-0">
                  <img src={goTechyLogo} alt="GoTechy" className="w-full h-full object-cover" />
                </div>
                <div>
                  <p className="flex items-center gap-1 text-[10px] sm:text-xs font-bold text-gray-800">
                    <svg viewBox="0 0 24 24" fill="#FF0000" className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                    GoTechy
                  </p>
                  <p className="text-[8px] sm:text-[10px] text-gray-500 font-medium leading-none sm:leading-normal">97.5K Subscribers</p>
                </div>
              </motion.a>
              ...
              <motion.a
                ...
                className="absolute -right-4 sm:-right-6 bottom-1/4 flex items-center gap-1.5 sm:gap-2.5 bg-white/90 backdrop-blur-md pl-1.5 pr-3 py-1.5 sm:pl-2 sm:pr-4 sm:py-2 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
              >
                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full overflow-hidden shadow-sm shrink-0">
              ...
              <motion.a
                ...
                className="absolute right-4 -top-2 flex items-center gap-1.5 sm:gap-2 bg-white/90 backdrop-blur-md px-2 py-1.5 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
              >
                <svg viewBox="0 0 24 24" fill="#000" className="w-3.5 h-3.5 sm:w-4 sm:h-4"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                <span className="text-[10px] sm:text-xs font-bold text-gray-800">@_GoTechy</span>
              </motion.a>
            </div>
          </motion.div>
        </div>
